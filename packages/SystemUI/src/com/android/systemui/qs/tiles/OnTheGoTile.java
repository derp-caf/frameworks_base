...
import com.android.internal.util.derp.OnTheGoActions;
import com.android.internal.util.derp.OnTheGoUtils;
...
public class OnTheGoTile extends QSTileImpl<BooleanState> {
    ...
    private static final String SERVICE_NAME = "com.android.systemui.derp.onthego.OnTheGoService";
    ...
    protected void handleUpdateState(BooleanState state, Object arg) {
        ...
        state.value = DerpUtils.isServiceRunning(mContext, SERVICE_NAME);
